...
import {CalendarRangeIcon, MessageSquare, MessageSquareText, PhoneCallIcon } from "lucide-react";
...
const Home = () => {
  ...
  return (
    ...
    <video autoPlay muted loop id="background-video" src={V4} >
  </video>
        <div className="home-hero-content">
        <div className="home-hero-col">
          <div className="tire-specials-carousel " style={{overflow:'hidden' , width:"400px"}}>
            {/* <h1 className='hero-heading-custom'>Expert <span style={{color:"#ffc513"}}>Automotive</span> Services in Delaware</h1> */}
            {/* <p style={{color:'white', fontSize:'17px'}}>Combining decades of local expertise with a dedication to quality, <span style={{color:"#ffc513"}}>we provide top-notch automotive care.</span>  Trust us to keep your vehicle in prime condition.</p> */}
...
<div className='bg-red' style={{ display:'flex' , justifyContent:'center'}}>
  
<a href="/specials/tire-specials/" style={{textAlign:'center' , fontWeight:'700'}}>
        See All Tire Specials <i className="fas fa-angle-double-right" />
      </a>
...
<div className="mt-4">
      <div className="lyft-banner">
        ...
        <div className="content">
          ...
          <p className="details d-flex" style={{marginTop:'-10px'}}>
            Certain restrictions apply.{" "}
             <u className='cursor-pointer'> Click for details
             </u>
      ...
      `}</style>
        ...
        <ul className="nav nav-tabs mb-3 w-100" style={{ fontSize: '20px' }}>
    <li className="nav-item flex-fill">
        <a className={`nav-link ${tabs === 'vehicle' ? 'active' : ''}`} onClick={()=> setTabs("vehicle")}>Vehicle</a>
    </li>
    <li className="nav-item flex-fill" onClick={()=> setTabs("size")}>
        <a className={`nav-link  ${tabs === 'size' ? 'active' : ''}`} href="#">Size</a>
    </li>
    <li className="nav-item flex-fill"  onClick={()=> setTabs("brand")}>
        <a className={`nav-link  ${tabs === 'brand' ? 'active' : ''}`} href="#">Brand</a>
    </li>
</ul>
        {tabs === 'vehicle' && (
        <form>
            ...
            <button type="submit" class="btn btn-shop"><span className="  w-6"style={{color:'white'}} >SHOP TIRES & BOOK APPOINTMENT</span></button>
        </form>
        )}
...
{tabs === 'size' && (
        <form>
            ...
            <button type="submit" class="btn btn-shop" style={{color:'white'}}><span className=" w-6" >SHOP TIRES & BOOK APPOINTMENT</span></button>
        </form>
        )}
    {tabs === 'brand' && (
       <>
        <button type="submit" class="btn btn-shop" style={{color:'white'}}><span className=" w-6" >Shop By Brand</span></button>
      </>
        )}
            </div>
      ...
      <div className="homepage-content-header">
        <div className="content-header-text">
          <div>
            <h2 style={{fontWeight:"700"}}>Did You Know We Are a Full Service Shop?</h2>
            <p>
              We don't just have the best tire prices in the Greater Philadelphia
              Area, we are also a full-service automotive maintenance and repair
              destination, with Master Techs on staff in every store!
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="locations-wrapper" >
        <div className="middle-content row-space-around-wrap">
          <a href="/locations/montgomeryville/">
            <div className="location-card" style={{width:'90%' , justifyContent:'left'}}>
              <img
              ...
              />
              <h4>Wilmington</h4>
<div style={{textAlign:'left' , marginLeft:'20px' , fontFamily:'Nunito'}}>
<CalendarRangeIcon style={{color:"#F2184F" , height:"20px" , width:"20px"}} /><span className="address text-left " style={{textAlign:'left' , marginTop:'20px' , fontWeight:"800",color:"#F2184F" , fontSize:"15px"}} > Main Service Center:
              </span>
             
              <p className="address text-left" style={{textAlign:'left' , fontSize:'24px' }} >401 S Dupont Hwy LOT B, New Castle, DE 19720</p>
              <CalendarRangeIcon style={{color:"#F2184F" , height:"20px" , width:"20px"}} />      <span className="address text-left " style={{textAlign:'left' , marginTop:'20px' , fontWeight:"800" , fontSize:"15px" , color:"#F2184F"}} >Wilmington Location:
:
              </span>
              <p className="address text-left" style={{textAlign:'left' , fontSize:'24px'  }} >456 Elm Street, Wilmington, Delaware, 19801
              </p>
      ...
      <div className="homepage-content-header">
        <div className="content-header-text">
          <div>
            <h2 style={{fontWeight:'700'}}>Flexibility For Your Convenience</h2>
            <p>
            ...
            <p className="small-print">
              *Same-Day Service only available until shop reaches booking capacity
              for the day. Please call ahead to confirm availability.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="amenity-row">
          ...
          <div className="amenity">
            ...
            <div>
              ...
              <p>
                You may be eligible for a complimentary Lyft ride to or from home
                or work.
              </p>
              <p className="small-print">
        ...
        <div className="amenity-row">
          <div className="amenity">
            ...
            <div>
              ...
              <p>
                WiFi. Outlets. Comfortable chairs. Complimentary beverages. If you
                need to wait, at least be comfortable!
              </p>
            </div>
          </div>
          <div className="amenity">
            ...
            <div>
              ...
              <p className="small-print">
                *These spots often book up early, so make sure to call ahead as
                soon as you can.
              </p>
            </div>
          </div>
      ...
      <div className="homepage-content-header">
        <div className="content-header-text">
          <div>
            ...
            <p>
              We offer multiple great options to finance your tire or automotive
              repair purchase with zero interest!
            </p>
            <p className="margin-top-1">
      ...
      <div className="homepage-content-header">
        <div className="content-header-text">
          <div>
            <h2  style={{fontWeight:'700'}}>Serving You and Your Neighbors</h2>
            <p>
      ...
      <div className="middle-content">
        <div className="row-space-around-wrap med-marg-top">
          <p className="large-print header-font">
            <a href="/locations/">
              <PhoneCallIcon />
              &nbsp; Give Us a Call
            </a>
